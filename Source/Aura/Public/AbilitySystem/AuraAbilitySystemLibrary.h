...
public:
	...
	UFUNCTION(BlueprintCallable,Category= "AuraAbilitySystemLibrary | Character Class Default")
	...
	UFUNCTION(BlueprintCallable,Category= "AuraAbilitySystemLibrary | Character Class Default")
	static void InitializedCommonAbilities(const UObject* WorldContextObject, UAbilitySystemComponent* ASC);
};
